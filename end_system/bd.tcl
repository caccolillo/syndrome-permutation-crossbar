...
################################################################
# This is a generated script based on design: aurora_bd
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set mgt_refclk_n_0 [ create_bd_port -dir I mgt_refclk_n_0 ]
  set mgt_refclk_p_0 [ create_bd_port -dir I mgt_refclk_p_0 ]
  set sfp0_rx_n_0 [ create_bd_port -dir I sfp0_rx_n_0 ]
  set sfp0_rx_p_0 [ create_bd_port -dir I sfp0_rx_p_0 ]
  set sfp0_tx_n_0 [ create_bd_port -dir O sfp0_tx_n_0 ]
  set sfp0_tx_p_0 [ create_bd_port -dir O sfp0_tx_p_0 ]

  # Create instance: aurora_top_0, and set properties
  set block_name aurora_top
  set block_cell_name aurora_top_0
  if { [catch {set aurora_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aurora_top_0 eq "" } {
...
\
  ...
  connect_bd_net -net aurora_top_0_channel_up [get_bd_pins aurora_top_0/channel_up] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net aurora_top_0_frame_err [get_bd_pins aurora_top_0/frame_err] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net aurora_top_0_hard_err [get_bd_pins aurora_top_0/hard_err] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net aurora_top_0_lane_up [get_bd_pins aurora_top_0/lane_up] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net aurora_top_0_sfp0_tx_n [get_bd_ports sfp0_tx_n_0] [get_bd_pins aurora_top_0/sfp0_tx_n]
  connect_bd_net -net aurora_top_0_sfp0_tx_p [get_bd_ports sfp0_tx_p_0] [get_bd_pins aurora_top_0/sfp0_tx_p]
  ...
  connect_bd_net -net sfp0_rx_n_0_1 [get_bd_ports sfp0_rx_n_0] [get_bd_pins aurora_top_0/sfp0_rx_n]
  connect_bd_net -net sfp0_rx_p_0_1 [get_bd_ports sfp0_rx_p_0] [get_bd_pins aurora_top_0/sfp0_rx_p]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins xpm_cdc_gen_0/src_in]
